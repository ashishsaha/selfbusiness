...
class CI_Upload {
	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		...
		$this->file_name = time().$this->_prep_filename($_FILES[$field]['name']); /*Change by Sanju*/
	...
	public function is_allowed_filetype($ignore_mime = FALSE)
	{
		...
		$image_types = array('gif', 'jpg', 'jpeg', 'png', 'jpe', 'doc', 'docs', 'pdf', 'PDF', 'image/gif', 'image/jpg', 'image/jpeg', 'image/png', 'image/jpe', 'image/bmp');
