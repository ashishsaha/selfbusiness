<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>employees/add" class="form-horizontal row-border" method="post"
            ...
            <div class="card-box">
                <div class="row">
                    <h4 class="header-title m-t-0 m-b-30"><i class="fa fa-arrows"></i> New Employee/Labor
                    </h4>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <option value="1">Casual Labor</option>
