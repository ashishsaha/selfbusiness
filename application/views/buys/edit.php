                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <table class=" table mrg20T table-hover table-style" style="margin-top: 6px">
                                    ...
                                    <input type="hidden" name="total_purchase_cost" id="total_purchase_cost" value="<?php echo $invoice_data->total_cost;?>" />
                                    <tr class="font-bold font-black tr-style" style="text-align: right">
                                        <td style="width: 50%;" align="right"> <b>Grand Total :</b></td>
                                        <td style="width: 20%;">&nbsp;</td>
                                        <td ><b>$<span id="total_purchase_cost_text"><?php echo number_format($invoice_data->total_cost,2);?></span></b></td>
                                    </tr>
