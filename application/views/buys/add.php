<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>buys/add" class="form-horizontal row-border" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                foreach ($suppliers as $supplier) {
                                    ?>
                                    <option
                                        value="<?php echo $supplier->id; ?>"><?php echo $supplier->full_name; ?></option>
                                <?php
                                }
                                ?>
                                </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control required" type="number" value="0"  min="1" step="0.01" name="data[total_bosta]" id="total_bosta" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control required" type="number" value="0"  min="1" step="0.01" name="data[price_per_mann]" id="price_per_mann" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control required" type="number" value="0" name="data[transportation_cost]" id="transportation_cost" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control required" placeholder="Casual Labor Cost"
                                       type="number"  min="0" step="0.01"
                                       name="data[casual_labor_cost]" id="casual_labor_cost" value="0"/>
                            </div>
                        </div>
                    </div>
