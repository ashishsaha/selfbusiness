        ...
        <div class="card-box">
            ...
            <table <?php if (count($sell_transaction_data) > 0){ ?>id="datatable-buttons" <?php } ?>
                ...
                <tr>
                    ...
                    <th style="width: 16%; text-align: right;" title="Amount">Amount</th>
                </tr>
                </thead>
                <tbody>
                <?php if (count($sell_transaction_data) > 0) {
                ...
                <table style="width: 1000px; padding-top: 10px;">
                    <tr>
                        <td style="width: 50%;">	
            				...
            				<strong>Supplier Name:</strong> <?php echo $sell_transaction_data[0]->full_name; ?>
            				</address>			            				
                        </td>
        ...
        <tr>
            <td style="height: 40px; background-color: #f5f5f5; color: #797979; border: none !important; padding: 10px 20px; border-top-left-radius: 3px; border-top-right-radius: 3px; outline: none !important; box-sizing: border-box;">
                <h2 style="font-weight: 600; margin-bottom: 0; margin-top: 0; line-height: 30px;">
                    <strong>Customer Wise Sales Transaction Report</strong>
                </h2>
            </td>
        </tr>
                            ...
                            <table style="width: 1000px; margin-bottom: 10px; padding: 120px; background-color: transparent;border-spacing: 0;border-collapse: collapse; box-sizing: border-box; font-size: 20px;">
                            	...
                            	<tbody>
                            		...
                            		<tr>
                            			...
                            			<td style="border-top: 2px solid; padding: 5px; line-height: 1.42857143; vertical-align: top; outline: none !important; box-sizing: border-box; text-align: right;"><strong>Accumulated Sale: </strong></td>
