<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>accounts/add" class="form-horizontal row-border" method="post"
            ...
            <div class="card-box">
                <div class="row">
                    <h4 class="header-title m-t-0 m-b-30"><i class="fa fa-arrows"></i> New Parent Account
                    </h4>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <div class="form-group address_div">
                            ...
                            <div class="col-md-9">
                                <input class="form-control required" placeholder="Parent Account Description"
                                       type="text"
