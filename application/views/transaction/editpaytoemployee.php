<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>transaction/edit_pay_to_employee/<?php echo $transaction_id; ?>"
            ...
            <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control required" name="data[payment_from_or_to]"
                                        id="payment_from_or_to" onchange="select_employee()" data-parsley-id="6">
                                    <option value="">Select employee</option>
                                    <?php
                                    foreach ($employee_list_data as $employee) {
                                        ?>
                                        <option value="<?php echo $employee->id; ?>"
                                                <?php if ($transaction_data->payment_from_or_to == $employee->id){ ?>selected="selected" <?php } ?>><?php echo $employee->full_name; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                ...
                <div class="row" id="ajaxShowDiv">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Employee Account</label>
                            <div class="col-md-9">
                                <?php
                                $sup_bank_account_name      = json_decode( $employee_data->bank_account_name);
                                $sup_bank_account_number    = json_decode( $employee_data->bank_account_number);
                                $sup_bank_name              = json_decode( $employee_data->bank_name);
                                $sup_bank_branch            = json_decode( $employee_data->bank_branch);
                                $sup_bank_location          = json_decode( $employee_data->bank_location);
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-9">
                                <select class="form-control required" name="data[salary_month]" id="salary_month" data-parsley-id="6">
                                    ...
                                    <option value="January" <?php if($transaction_data->salary_month == "January"){?>selected="selected" <?php } ?>>January</option>
                                    <option value="February" <?php if($transaction_data->salary_month == "February"){?>selected="selected" <?php } ?>>February</option>
                                    <option value="March" <?php if($transaction_data->salary_month == "March"){?>selected="selected" <?php } ?>>March</option>
                                    <option value="April" <?php if($transaction_data->salary_month == "April"){?>selected="selected" <?php } ?>>April</option>
                                    <option value="May" <?php if($transaction_data->salary_month == "May"){?>selected="selected" <?php } ?>>May</option>
                                    <option value="June" <?php if($transaction_data->salary_month == "June"){?>selected="selected" <?php } ?>>June</option>
                                    <option value="July" <?php if($transaction_data->salary_month == "July"){?>selected="selected" <?php } ?>>July</option>
                                    <option value="August" <?php if($transaction_data->salary_month == "August"){?>selected="selected" <?php } ?>>August</option>
                                    <option value="September" <?php if($transaction_data->salary_month == "September"){?>selected="selected" <?php } ?>>September</option>
                                    <option value="October" <?php if($transaction_data->salary_month == "October"){?>selected="selected" <?php } ?>>October</option>
                                    <option value="November" <?php if($transaction_data->salary_month == "November"){?>selected="selected" <?php } ?>>November</option>
                                    <option value="December" <?php if($transaction_data->salary_month == "December"){?>selected="selected" <?php } ?>>December</option>
                                </select>
                            </div>
                        </div>
                    </div>
