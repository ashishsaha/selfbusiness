        ...
        <div class="card-box table-responsive">
            <h4 class="header-title m-t-0 m-b-30"><i class="fa fa-tree"></i> <?php echo $sidebar_menu; ?>&nbsp;
                ...
                <ul class="list-status">
                    ...
                    <li>
                        <button type="button" class="btn" onclick="javascript:homecost_cancel();"><i
...
<script type="text/javascript">
    function edit_home_cost(id) {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, XMLHttpRequest) {
                ...
                $('#form1').attr('action', '<?php echo base_url(); ?>transaction/edit/'+id);
    ...
    function add_home_expense() {
        ...
        $("#trans_date").val(trans_date);
        $('#form1').attr('action', '<?php echo base_url(); ?>transaction/home_cost');
    ...
    function homecost_cancel(){
        window.location.href = '<?php echo base_url();?>transaction/pay';
    }

    function delete_transaction(id) {
        window.location.href = '<?php echo base_url();?>transaction/delete/homecost/' + id;
    }
