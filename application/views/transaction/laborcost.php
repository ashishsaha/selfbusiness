    ...
    <div class="col-sm-12">
        ...
        <div class="card-box table-responsive">
            ...
            <div id="adding_form" class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url(); ?>transaction/labor_cost" class="form-horizontal row-border" method="post" name="form1" id="form1" enctype="multipart/form-data" novalidate="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-6" style="text-align: right">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <button type="button" class="btn" onclick="javascript:home_cost_cancel();"><i class="fa fa-ban" aria-hidden="true"></i> Cancel
                                            </button>
            ...
            <?php //echo '<pre>'; print_r($home_cost_transaction_data);?>

            <table <?php if (count($home_cost_transaction_data) > 0){ ?>id="datatable-buttons"<?php } ?>
                   class="table table-striped table-bordered">
                <thead>
                <tr>
                    <th title="Transaction through">Casual/Labor Name</th>
                    <th title="Transaction through">Employee Type</th>
                ...
                <?php if (count($home_cost_transaction_data) > 0) {
                    ...
                    foreach ($home_cost_transaction_data as $transaction_data) {
                        ...
                        if($transaction_data->employee_type == 1){
                            $employee_type = '<span class="label label-success">Casual Labor</span>';
                        }else{
                            $employee_type = '<span class="label label-info">Labor</span>';
                        }
                        ?>
...
<script type="text/javascript">
    function edit_home_cost(id) {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, XMLHttpRequest) {
                ...
                $('#form1').attr('action', '<?php echo base_url(); ?>transaction/editlaborcost/'+id);
    ...
    function add_home_expense() {
        ...
        $("#trans_date").val(trans_date);
        $('#form1').attr('action', '<?php echo base_url(); ?>transaction/labor_cost');
    ...
    function delete_transaction(id) {
        window.location.href = '<?php echo base_url();?>transaction/delete/laborcost/' + id;
    }
