        ...
        <div class="card-box table-responsive">
            <h4 class="header-title m-t-0 m-b-30"><i class="fa fa-tree"></i> <?php echo $sidebar_menu; ?>&nbsp;
                ...
                <ul class="list-status">
                    ...
                    <li>
                        <button type="button" class="btn" onclick="javascript:paytoemployee_cancel();"><i
            ...
            <div id="adding_form" class="row">
                <div class="col-sm-12">
                    <form action="<?php echo base_url(); ?>transaction/pay_to_employee" class="form-horizontal row-border" method="post" name="form1" id="form1" enctype="multipart/form-data" novalidate="">
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" title="Trans Date">Trans Date</label>
                                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" title="Note">Note</label>
                                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-6" style="text-align: right">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <button type="button" class="btn" onclick="javascript:add_pay_to_employee_cancel();"><i class="fa fa-ban" aria-hidden="true"></i> Cancel
                                            </button>
...
<script type="text/javascript">
    ...
    function add_pay_to_employee() {
        ...
        $('select#salary_month option').removeAttr("selected");
        var d = new Date();
        var trans_date = ("0" + (d.getMonth() + 1)).slice(-2) + "/" + ("0" + d.getDate()).slice(-2) + "/" + d.getFullYear();
        $("#trans_date").val(trans_date);
        $('#form1').attr('action', '<?php echo base_url(); ?>transaction/pay_to_employee');
    ...
    function edit_pay_to_employee(id) {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, XMLHttpRequest) {
                ...
                var salary_month_val = data.salary_month;
                $("#salary_month option[value='" + salary_month_val + "']").prop('selected', true);
    ...
    */
    function add_pay_to_employee_cancel() {
        $("#adding_form").hide(400);
    }
    
    function paytoemployee_cancel(){
