<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>users/add_admin" class="form-horizontal row-border" method="post"
              name="form1" id="form1" enctype="multipart/form-data">
            <input type="hidden" name="action" id="action" value="">
            <input type="hidden" name="OkSaveData" id="OkSaveData" value="TRUE">
            <input type="hidden" name="data[corporate_account_id]" id="corporate_account_id" value="<?php echo $this->session->userdata['userData']['session_corporate_account_id']; ?>">
            <input type="hidden" name="data[role_id]" id="role_id" value="3">

            <div class="card-box">
                <div class="row">
                    <h4 class="header-title m-t-0 m-b-30"><i class="fa fa-info-circle"></i> Create Admin User
                    </h4>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="form-control required" placeholder="Contact No" type="number"
