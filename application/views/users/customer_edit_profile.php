<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>users/customer_edit_profile/<?php echo $this->session->userdata['userData']['session_user_id']; ?>"
            ...
            <input type="hidden" name="page_location" id="page_location" value="<?php //echo $_SERVER['HTTP_REFERER']; ?>">
