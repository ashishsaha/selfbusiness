<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>users/add" class="form-horizontal row-border" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                foreach ($role_list as $roleList) {
                                    if ($roleList->id != 1) { // show the list exept System Super Admin
                                        ?>
                                        <option
                                            value="<?php echo $roleList->id; ?>"><?php echo $roleList->name; ?></option>
                                        <?php
                                    }
                                }
                                ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" placeholder="Contact No" type="number"
