<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(); ?>users/edit_customer/<?php echo $user_id; ?>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="form-control <?php if ($is_customer_number_required == 1) { ?> required <?php } ?>" placeholder="Contact No" type="text"
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <button type="button" class="btn" onclick="javascript:customers_cancel();"><i
