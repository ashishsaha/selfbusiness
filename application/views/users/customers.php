        ...
        <div class="card-box table-responsive">
            ...
            <h4 class="header-title m-t-0 m-b-30"><i class="fa fa-tree"></i> <?php echo $sidebar_menu; ?>&nbsp;
                ...
                <ul class="list-status">
                    ...
                    <li>
                        <button title="Add Customer" data-tooltip="true" type="button"
                                class="btn btn-primary waves-effect waves-light" onclick="javascript:add_customer();"><i
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <button title="Edit User" data-tooltip="true" type="button"
                                        ...
                                        onclick="javascript:edit_customer(<?php echo $user->id; ?>);">
...
<script type="text/javascript">
    function edit_customer(id) {
        window.location.href = '<?php echo base_url();?>users/edit_customer/' + id;
    }

    function add_customer() {
        window.location.href = '<?php echo base_url();?>users/add_customer';
    }

    function delete_customer(id) {
        window.location.href = '<?php echo base_url();?>users/delete_customer/' + id;
    }
